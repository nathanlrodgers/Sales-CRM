  ...
  const handleSignIn=async()=>{
    ...
    if(res.access_token){
      ...
      if(profiles&&profiles.length>0){
        ...
        onLogin(res.access_token,profile.workspace_id,profile.full_name||email);
      } else {
      ...
      if(inviteToken){
        ...
        if(invites&&invites[0]&&!invites[0].used){
          ...
          if(signInRes.access_token){
            ...
            onLogin(signInRes.access_token,invites[0].workspace_id,name);
            return;
          }
        } else {
...
export default function App(){
  ...
  useEffect(()=>{
    ...
    if(token&&workspaceId){
      setSession({token,workspaceId,userName:userName||"User"});
    }
    setAuthChecked(true);
  },[]);
  ...
  const handleLogin=(token,workspaceId,userName)=>{
    setSession({token,workspaceId,userName});
  };
